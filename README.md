...
## Project Structure
    ...
    ├── testwsdwadwqdwd_dev_45285  # Django project configurations
...
1. Clone this repo and `cd testwsdwadwqdwd_dev_45285`
...
2. Clone this repo and `cd testwsdwadwqdwd_dev_45285`
